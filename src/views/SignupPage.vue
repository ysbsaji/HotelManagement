<template>
  <v-container>
    <v-layout class="text-center my-12 ml-12">
      <v-flex xs3 style="background-image: url('@/assets/logo-hotel.png')">
        <v-card height="400px">
          <img class="my-12" src="https://img.freepik.com/free-vector/login-concept-illustration_114360-757.jpg?size=338&ext=jpg" alt="" width="80%">
        </v-card>
      </v-flex>
